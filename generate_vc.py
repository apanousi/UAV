...
# startingLocationA = Location(41.7144367,-86.2417136)
# startingLocationB = Location(41.7145629,-86.2465112)
# targetLocationA   = Location(41.7145629,-86.2465112)
# targetLocationB   = Location(41.7144367,-86.2417136)



# print(check_crossingpoint(startingLocationA, startingLocationB, targetLocationA, targetLocationB))
#print(check_crossingpoint(0,0,2,2,2,2,0,0))
#print(generate_vc(startingLocationA, startingLocationB, targetLocationA, targetLocationB, 10))
